...
export const editorTourSteps = [
  ...
  },
  {
    ...
    description:
      "반경 도구를 고르고 마커를 선택한 뒤 거리를 입력합니다. 사각형 자체는 반경의 기준이 될 수 없습니다. 먼저 그리기에서 마커를 추가하세요.",
    action: "예제: 경복궁 안에 마커 하나를 놓고 그 주위의 반경을 만들어보세요.",
  },
  {
    id: "layers",
    label: "레이어",
  ...
  },
  {
    ...
    action:
      "예제: 문서로 돌아오면 지도와 ‘방금 돌려받은 scene JSON’을 확인하세요.",
  },
] as const;
