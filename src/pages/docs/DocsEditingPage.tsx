          ...
          rows={[
            ...
            },
            {
              ...
              cells: [
                ...
                "Google 로그인 후 행정동·법정동·우편번호를 조회합니다. 호버 없이 보이는 경계 카드에서 추가·합치기·빼기를 실행합니다.",
                "이름은 줌에 따라 14–16px, 버튼은 32–36px로 표시합니다. 밀집 구간은 겹치는 카드를 줄이며 생략된 경계는 포인터·클릭 또는 확대 후 접근할 수 있습니다. 편집 연산은 원본을 사용하며 서버 경계는 변경하지 않습니다.",
              ],
            },
            {
              key: "hole-fill",
